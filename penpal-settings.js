...
const PROVIDER_MODELS = {
  openrouter: [
    ...
    { value: "openai/gpt-4o",                        label: "GPT-4o — best OpenAI quality" },
  ...
  mistral: [
    { value: "open-mistral-7b",       label: "Mistral 7B — cheapest" },
  ...
  meta: [
    { value: "meta-llama/llama-3.1-8b-instruct",   label: "Llama 3.1 8B (via OpenRouter)" },
  ...
  groq: [
    ...
    { value: "llama-3.2-90b-text-preview", label: "Llama 3.2 90B" },
  ...
  cohere: [
    ...
    { value: "command",        label: "Command — fast" },
  ],
  together: [
  ...
  deepseek: [
    { value: "deepseek-chat",     label: "DeepSeek Chat (V3) — best value" },
...
const MODEL_RECOMMENDATIONS = {
  openrouter: [
    ...
    { badge: "fast",  label: "Fast & capable",   model: "openai/gpt-4o-mini",                note: "GPT-4o Mini — great balance of speed and quality" },
    { badge: "free",  label: "Free tier",        model: "meta-llama/llama-3.1-8b-instruct",  note: "Llama 3.1 8B — no cost, surprisingly good" },
  ],
  openai: [
    { badge: "best",  label: "Best for writing", model: "gpt-4o",      note: "GPT-4o — richest vocabulary, best at matching tone" },
    { badge: "value", label: "Best value",       model: "gpt-4o-mini", note: "GPT-4o Mini — 90% of the quality at a fraction of the cost" },
  ],
  anthropic: [
    { badge: "best",  label: "Best for writing", model: "claude-sonnet-4-5", note: "Claude Sonnet 4.5 — exceptional at matching tone and voice" },
    { badge: "fast",  label: "Fast & cheap",     model: "claude-haiku-4-5",  note: "Claude Haiku 4.5 — great for quick grammar fixes" },
  ],
  google: [
    { badge: "best",  label: "Best quality", model: "gemini-1.5-pro",   note: "Gemini 1.5 Pro — strong multilingual writing support" },
    { badge: "free",  label: "Free tier",    model: "gemini-1.5-flash",  note: "Gemini 1.5 Flash — fast and free for most users" },
  ],
  mistral: [
    { badge: "best",  label: "Best for writing", model: "mistral-large-latest", note: "Mistral Large — best prose quality in the Mistral family" },
    { badge: "value", label: "Best value",       model: "open-mistral-7b",      note: "Mistral 7B — lightweight and capable" },
  ],
  meta: [
    { badge: "best",  label: "Best quality", model: "meta-llama/llama-3.1-70b-instruct", note: "Llama 3.1 70B — best open-source writing quality" },
    { badge: "free",  label: "Free tier",    model: "meta-llama/llama-3.1-8b-instruct",  note: "Llama 3.1 8B — free via OpenRouter" },
  ],
  groq: [
    { badge: "best",  label: "Best quality", model: "llama-3.1-70b-versatile", note: "Llama 3.1 70B — best writing quality on Groq" },
  ...
  together: [
    { badge: "best",  label: "Best quality", model: "meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo", note: "Llama 3.1 70B Turbo — fast and high quality" },
    { badge: "value", label: "Best value",   model: "meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo",  note: "Llama 3.1 8B Turbo — cheap and quick" },
  ],
  fireworks: [
    { badge: "best",  label: "Best quality", model: "accounts/fireworks/models/llama-v3p1-70b-instruct", note: "Llama 3.1 70B — best writing results" },
    { badge: "fast",  label: "Fastest",      model: "accounts/fireworks/models/llama-v3p1-8b-instruct",  note: "Llama 3.1 8B — fastest option" },
  ],
  deepseek: [
    { badge: "value", label: "Best value",   model: "deepseek-chat",     note: "DeepSeek Chat (V3) — excellent quality for the price" },
    { badge: "best",  label: "Most capable", model: "deepseek-reasoner", note: "DeepSeek R1 — great for complex rewrites" },
  ],
  xai: [
    { badge: "best",  label: "Best available", model: "grok-beta", note: "Grok Beta — best current option from xAI" },
  ],
};
